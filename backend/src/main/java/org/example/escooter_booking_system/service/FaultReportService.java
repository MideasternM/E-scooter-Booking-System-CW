...
public interface FaultReportService {
    // 创建新的故障报告
    FaultReport createFaultReport(FaultReportDTO faultReportDTO);
    ...
    // 分配故障给维修人员
    FaultReport assignToStaff(Long id, Long staffId);

    // 更新故障状态
    FaultReport updateStatus(Long id, String status, String notes);
